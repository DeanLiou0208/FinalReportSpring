...
public class ShoppingCartBeanDaoTests {
...
//	@Test
	...
	@Test
	public void CheckShoppingCartExit() {
		boolean checkShoppingCartExit = shoppingCartBeanDao.CheckShoppingCartExit(1, 2);
		System.out.println(checkShoppingCartExit);
	}
