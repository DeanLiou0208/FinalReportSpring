...
public class CollectionPetArticleView {
...
//	private Integer id;
	...
	public String toString() {
		return "CollectionPetArticleView [fkMemberId=" + fkMemberId + ", uid=" + uid + ", title=" + title
				+ ", petArticleText=" + petArticleText + ", type=" + type + ", lastTime=" + lastTime + ", likeCount="
				+ likeCount + ", unlikeCount=" + unlikeCount + ", createAt=" + createAt + "]";
	}
